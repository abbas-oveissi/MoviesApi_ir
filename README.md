...
9. اکنون میتوانید از وب‌سرویس استفاده کنید اما فیلمی در آن ثبت نشده است. اگر می‌خواهید اطلاعات ۱۵ فیلم برتر به همراه ژانرشان در جدول‌ها ثبت شود، دستور زیر را اجرا کنید.
