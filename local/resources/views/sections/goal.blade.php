    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-xs-12 api-box text-justify">
                ...
                <p>در آینده‌‌ی نزدیک متدهای بیشتری به این وب سرویس اضافه می‌شود و حتی توسعه‌دهندگان می‌توانند از GraphQL برای دریافت اطلاعات از وب‌سرویس استفاده کنند. این پروژه متن‌باز هست و از همکاری همه‌ی توسعه‌دهنگان استقبال می‌شود.</p>
            </div>
