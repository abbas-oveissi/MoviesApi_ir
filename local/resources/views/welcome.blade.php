    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-xs-12 api-box text-justify">
                ...
                <p>در آینده‌‌ی نزدیک متدهای بیشتری به این وب سرویس اضافه می‌شود و حتی توسعه‌دهندگان می‌توانند روش‌های authentication مثل jwt را امتحان کنند. هنوز برای متن باز شدن پروژه تصمیمی گرفته نشده است اما از همکاری توسعه‌دهنگان دیگر استقبال می‌شود.</p>
            </div>
